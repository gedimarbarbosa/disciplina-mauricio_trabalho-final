...
#exercicio usando sa_sem_rep para a megasena
...
#aqui precisa usar a função rep
...
#Se usarmos dois colchetes [[]] ele me retorna o valor atribuído ao elemento
...
setwd("D:/Ge/github/disciplina-analise-geoespacial-r/03_dados/tabelas")

# verificar o diretorio
getwd()

# verificar os arquivos dentro do diretorio
dir()
list.files()
...
da <- read.table("ATLANTIC_AMPHIBIANS_sites.txt", header = TRUE, sep = "\t", row.names = 1)
da
...
write.csv(da_sp, "ATLANTIC_AMPHIBIAN_sites_sao_paulo.csv", quote = FALSE)
